...
```{r,eval=F}
trumptweets <- read_csv("https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/trump_tweets.csv")
#View(trumptweets)
glimpse(trumptweets)
tweets <- trumptweets %>%
...
```{r}
tweets <- read_rds(file="https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Trumptweets.Rds")
```
