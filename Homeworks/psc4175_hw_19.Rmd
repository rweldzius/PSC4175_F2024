...
require(tidytext)
require(scales)
tweet_words <- read_rds(file="https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Trump_tweet_words.Rds") %>% # Note you can add data manipulations directly to the code that opens the file!
