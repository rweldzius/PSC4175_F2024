...
```{r, message=FALSE}
library(tidyverse)
dat <- read_csv('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/H097_members.csv')
glimpse(dat)
```
...
dat <- read_csv('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/H117_members.csv')
datClust <- dat %>% 
  mutate(party = ifelse(party_code == 200,'R',
                        ifelse(party_code == 100,'D','I'))) %>%
...
- Homework:
  ...
  - Problem set 9 (due next week!)
  
  - Homework 18
  
- Quiz (I didn't forget!)
