...
require(tidyverse)
tweet_words <- read_rds(file="https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/Trump_tweet_words.Rds")
...
nrc <- read_rds('https://github.com/rweldzius/PSC4175_F2024/raw/main/Data/nrc.Rds')
```
...
- Week 1-3: R basics, ggplot, and **MORE ggplot**!!

--

- Week 4: Data wrangling and univariate analysis (**AND MORE ggplot!**)

--

- Week 5-6: Multivariate analysis (conditional means)
...
- Week 8-9: Midterm and Fall Break 

--

- Week 10-11: Linear regression

--

- Week 12-13: Logistic regression

--

- Week 14-15: K-means clustering and Natural Language Processing

--

- $\color{blue}{\text{Week 16-17: Final project workshop and mini-conference}}$

--

- $\color{blue}{\text{December 18: Final projects due and take-home final exam distributed (if needed)}}$
...
- Homework:
  ...
  - Problem set 8 **due Wednesday**. LAST ONE!
  
  - Come next Monday with your data for the final project
  
--
  
- Quiz (also the last one!)

  - Go to gosocrative.com; room name PSC4175
